...
Exchange 2.0/3.0 only supports Nebula Graph 2.0/3.0 . If you want to import data for Nebula Graph v1.x，please use [Nebula Exchange v1.0](https://github.com/vesoft-inc/nebula-java/tree/v1.0/tools/exchange).
...
1. Package latest Exchange
    ...
    After the packaging, you can see the newly generated nebula-exchange_spark_2.2-3.0.0.jar under the nebula-exchange/nebula-exchange_spark_2.2/target/ directory,
    nebula-exchange_spark_2.4-3.0.0.jar under the nebula-exchange/nebula-exchange_spark_2.4/target/ directory, 
    nebula-exchange_spark_3.0-3.0.0.jar under the nebula-exchange/nebula-exchange_spark_3.0/target/ directory.
...
```
$SPARK_HOME/bin/spark-submit --class com.vesoft.nebula.exchange.Exchange --master local nebula-exchange_spark_2.4-3.0.0.jar -c /path/to/application.conf -h
```
